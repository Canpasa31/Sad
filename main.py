...
def button():
	BUTTON=[[InlineKeyboardButton(text="👨🏻‍💻 Sahibim ",url="t.me/adsizkaptan")]]
	BUTTON+=[[InlineKeyboardButton(text="🌱 Open Source 🌱",url="https://t.me/bykralbey")]]
